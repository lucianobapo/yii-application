...
class Hybrid_Auth 
{
	...
	*/
	public static function initialize( $config )
	{
		...
		Hybrid_Logger::debug( "Hybrid_Auth initialize. dump used config: ", CVarDumper::dumpAsString( $config ) );
		Hybrid_Logger::debug( "Hybrid_Auth initialize. dump current session: ", CVarDumper::dumpAsString(Hybrid_Auth::storage()->getSessionData()) );
