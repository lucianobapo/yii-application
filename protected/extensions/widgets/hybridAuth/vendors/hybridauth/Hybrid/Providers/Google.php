...
class Hybrid_Providers_Google extends Hybrid_Provider_Model_OAuth2
{
	...
	public $user_api = "https://www.googleapis.com/oauth2/v1/userinfo";
	//public $user_api = "https://www.googleapis.com/plus/v1/people/me";
	...
	*/
	function getUserProfile()
	{
		...
		$response = $this->api->api( $this->user_api );
