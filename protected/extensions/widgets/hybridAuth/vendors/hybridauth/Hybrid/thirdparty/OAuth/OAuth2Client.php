...
class OAuth2Client
{
	...
	*/
	...
	{
		Hybrid_Logger::info( "Enter OAuth2Client::api( $url )" );
		Hybrid_Logger::debug( "OAuth2Client::api(). dump request params: ", CVarDumper::dumpAsString( $parameters ) );
	...
	*/
	...
	public function tokenInfo($accesstoken)
	{
		...
		Hybrid_Logger::info( "Enter OAuth2Client::tokenInfo( $accesstoken )" );
		Hybrid_Logger::debug( "OAuth2Client::tokenInfo(). dump request params: ", CVarDumper::dumpAsString( $params ) );
	...
	private function request( $url, $params=false, $type="GET" )
	{
		...
		Hybrid_Logger::debug( "OAuth2Client::request(). dump request params: ", CVarDumper::dumpAsString( $params ) );
		...
		Hybrid_Logger::debug( "OAuth2Client::request(). dump request info: ", CVarDumper::dumpAsString( curl_getinfo($ch) ) );
		Hybrid_Logger::debug( "OAuth2Client::request(). dump request result: ", CVarDumper::dumpAsString( $response ) );
