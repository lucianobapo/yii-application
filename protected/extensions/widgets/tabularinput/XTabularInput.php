...
SCRIPT;
	...
	{
		//$this->removeLabel=$this->evaluateExpression($this->removeLabel);
		//$this->removeTemplate=$this->evaluateExpression($this->removeTemplate);
		//$this->removeHtmlOptions=$this->evaluateExpression($this->removeHtmlOptions);
