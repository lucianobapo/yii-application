...
class Sourcemessage extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'category' => utf8_encode(Yii::t('tables', 'sourcemessageCategory', array(), 'i18n')),
			'message' => utf8_encode(Yii::t('tables', 'sourcemessageMessage', array(), 'i18n')),
			'messages' => utf8_encode(Yii::t('tables', 'sourcemessageMessages', array(), 'i18n')),
		);
	}
	...
	public static function rolesUser($userRow) {
		$grupos='';
		foreach ($userRow as $key => $value) $grupos.=$value->language.': '.utf8_encode($value->translation)."<br>\n ";
		return $grupos;
	}
