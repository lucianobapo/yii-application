...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('data_update')); ?>:</b>
	<?php echo CHtml::encode($data->data_update); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('id_entidade')); ?>:</b>
	<?php echo CHtml::encode($data->id_entidade); ?>
	<br />
