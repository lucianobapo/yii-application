...
<div class="row-fluid">
	<div class="span6">
		<h4><?php echo Helpers::t('appUi', 'Endereço de Entrega (principal): ')?></h4>
		<ul class="list-blog-roll">
			<li><?php echo Helpers::t('appUi', 'CEP: ').$endereco->cep; ?></li>
			<li><?php echo Helpers::t('appUi', 'Cidade: ').$endereco->cidade.'/'.$parceiro->estado; ?></li>
			<li><?php echo Helpers::t('appUi', 'Bairro: ').$endereco->bairro; ?></li>
			<li><?php echo Helpers::t('appUi', 'Endereço: ').$endereco->logradouro.', '.$endereco->complemento; ?></li>
	...
	<div class="sb16">
		...
		<?php $form=$this->beginWidget('CActiveForm', array(
            ...
            'action'=>$action=$this->createUrl ( '/' . Helpers::getModuleName() . '/deliveryPedido/confirma',array('id'=>$id) ),
		...
		<div class="buttons">
			...
			<?php echo $form->hiddenField($model,'status_fechado',array('value'=>1)) ?>
