...
/**
 * This is the model class for table "erpnet_estoque".
 *
 * The followings are the available columns in table 'erpnet_estoque':
 * @property integer $id
 ...
 */
class ErpnetEstoque extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_produto, id_wbs,  data_movimento,  quantidade, tipo', 'required'),
			array('usuario, descricao_wbs, turno, id_ordem, obs', 'safe'),
			array('obs', 'required', 'on'=>'manual'),
			...
			array('id, empresa, id_produto, id_ordem, id_wbs, descricao_wbs, data_criacao, data_movimento, usuario, quantidade, tipo', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ErpnetEstoque the static model class
	 */
	...
	public function beforeSave() {
		//$this->data_movimento = date('Y-m-d', CDateTimeParser::parse($this->data_movimento, Yii::app()->locale->dateFormat));
