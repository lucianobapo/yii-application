...
/**
 * This is the model class for table "erpnet_pagar".
 *
 * The followings are the available columns in table 'erpnet_pagar':
 * @property integer $id
 ...
 */
class ErpnetPagar extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('empresa, id_produto, id_wbs, data_movimento, usuario, quantidade, tipo', 'required'),
			array('id_produto, id_ordem, id_parceiro, id_wbs', 'numerical', 'integerOnly'=>true),
			array('quantidade, valor', 'numerical'),
			array('empresa, descricao_wbs, usuario', 'length', 'max'=>255),
	 ...
	 * @return ErpnetPagar the static model class
	 */
