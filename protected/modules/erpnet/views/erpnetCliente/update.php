...
<h3><?php echo utf8_encode(Yii::t('app', 'breadUpdate', array(), 'i18n')); ?> <?php echo utf8_encode(Yii::t('erpnetUi', 'viewCreateClientesTitle', array(), 'i18n')); ?> <?php echo $model->id; ?></h3>
