...
$('.search-form form').submit(function(){
	$('#erpnet-grupo-produto-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h3><?php echo utf8_encode(Yii::t('erpnetUi', 'viewGrupoProdutosTitle', array(), 'i18n')); ?></h3>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
			...
			'template' => '{delete}{ativar}',
			'buttons'=>array(
				'delete'=>array(
					'visible'=>'ErpnetGrupoProduto::model()->findByPk($data->id)->ativado',
					'label' => 'Desativar',
				),
				'ativar'=>array(
					'visible'=>'(!ErpnetGrupoProduto::model()->findByPk($data->id)->ativado)',
					'label' => 'Ativar', // text label of the button
					'url' => 'Yii::app()->createUrl(Helpers::getModuleName()."/erpnetGrupoProduto/ativar", array("id"=>$data->id))', //Your URL According to your wish
