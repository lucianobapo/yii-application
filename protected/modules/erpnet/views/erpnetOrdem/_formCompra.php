...
?>
	...
	<div class="controls-row">
		<?php echo $form->DropDownList($model,'id_cliente',ErpnetCliente::getItens(true,'tipo_fornecedor'),array('class'=>'span5','empty'=>'--Selecione--')); ?>	
	</div>
	<div class="controls-row">
	...
	<div class="controls-row">	
		...
		?>
		<?php echo $form->DropDownList($model,'id_wbs',ErpnetWbs::getItens(false,'estoque'),array('class'=>'span3')); ?>
	</div>
	<div class="controls-row">
		<?php //echo $form->error($model,'data_termino',array('class'=>'span2')); ?>
		<?php //echo $form->error($model,'id_wbs',array('class'=>'span3')); ?>
	</div>
	<?php echo $form->hiddenField($model,'tipo',array('value'=>'compra')) ?>
