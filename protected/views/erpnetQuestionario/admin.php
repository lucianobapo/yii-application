...
$('.search-form form').submit(function(){
	$('#erpnet-questionario-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h3><?php echo utf8_encode(Yii::t('app', 'breadManage', array(), 'i18n')); ?> Erpnet Questionarios</h3>
