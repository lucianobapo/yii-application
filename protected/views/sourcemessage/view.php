...
<h3><?php echo utf8_encode(Yii::t('app', 'breadView', array(), 'i18n')); ?> Sourcemessage #<?php echo $model->id; ?></h3>
...
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes'=>array(
		...
		'message',
		array(
			'label'=>$model->getAttributeLabel('messages'),
			'type' => 'html',
			'value'=>Sourcemessage::rolesUser($model->messages),
		),
	),
)); ?>
